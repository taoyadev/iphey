...
export default function APIReferenceClient() {
  ...
  const reportEndpoint = `${API_URL}/api/v1/report`;
      ...
      <div className="space-y-16">
        ...
        <Section variant="ghost" icon={Server} title="Base URL">
          ...
          >
            ...
            <code className="block bg-black/40 rounded-lg p-4 text-white font-mono text-sm">{`${API_URL}/api/v1`}</code>
          ...
          >
            <div>
              ...
              <pre className="bg-surface/60 border border-white/5 rounded-2xl p-6 overflow-x-auto">
                <code className="text-sm text-slate-300 font-mono">{`const response = await fetch('${reportEndpoint}', {
  method: 'POST',
  headers: {
