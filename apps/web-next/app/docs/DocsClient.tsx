        ...
        <Section variant="ghost" icon={Download} title="How Do I Install IPhey?">
          ...
          >
            ...
            <p className="text-lg text-slate-300 leading-relaxed mb-6">
              ...
              <code className="text-accent bg-accent/10 px-2 py-1 rounded">{SITE_HOST}</code>, and our system
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-400 leading-relaxed">
                      Open your browser and navigate to <code className="text-accent">{SITE_HOST}</code>. Works on
